...
class _PromoDetailViewState extends State<PromoDetailView> {
  ...
  Widget build(BuildContext context) {
    final title = widget.activity.title.isEmpty
        ? 'promoCenter'.tr
...
String _cleanHtml(String html) {
  return html
      .replaceAll(RegExp(r'(<br\s*/?>(\s*<br\s*/?>)*\s*</p>)', caseSensitive: false), '</p>')
      .replaceAll(RegExp(r'(<p[^>]*>\s*(<br\s*/?>)?\s*</p>\s*)+$', caseSensitive: false), '')
      .trimRight();
}
