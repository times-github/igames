import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-DWsn5rte.js";
import { a as resolveGatewayPort, n as STATE_DIR } from "./paths-C6TxBCvO.js";
...
import { B as canonicalizeMainSessionAlias, K as acquireSessionWriteLock, V as resolveAgentMainSessionKey } from "./sessions-_Cu6BqJv.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-Bcm94hV8.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CPlpJFd0.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-CPlpJFd0.js")).closePlaywrightBrowserConnection();
	} catch {}
}
