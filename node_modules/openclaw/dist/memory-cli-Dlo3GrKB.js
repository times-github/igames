...
import { F as loadConfig, lt as parseDurationMs, yn as splitShellArgs } from "./auth-profiles-CNyDTsy4.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-DuFk7JfV.js";
import { b as shortenHomeInString, v as resolveUserPath, x as shortenHomePath } from "./utils-cwpAMi-t.js";
...
import { r as getMemoryCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-B3asrqY0.js";
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-Dz8NAfL4.js";
import { t as formatDocsLink } from "./links-BMokj3K3.js";
import { r as withManager } from "./cli-utils-DjLJITj6.js";
import { t as formatHelpExamples } from "./help-format-D_fwVCrM.js";
import { n as withProgress, r as withProgressTotals } from "./progress-CcvPqJyX.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-C8BwK-Ko.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-BpC_d51I.js").then((n) => n.t);
