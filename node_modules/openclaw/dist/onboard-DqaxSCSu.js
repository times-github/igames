...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-BfkFJ4uQ.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-BallfiRO.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-3ZmrkfCf.js";
import { t as runOnboardingWizard } from "./onboarding-N833r5v5.js";
import { n as logConfigUpdated } from "./logging-uAKXu_UT.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-CfaXCT3s.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-DevG0dl6.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DpjRsMfR.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CL9m6ctA.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-fOOBvmWF.js").then((n) => n.i);
