import { r as STATE_DIR } from "./paths-BMo6kTge.js";
import { d as defaultRuntime, t as createSubsystemLogger } from "./subsystem-kl-vrkYi.js";
import { F as loadConfig, ot as getBlockedNetworkModeReason } from "./auth-profiles-CNyDTsy4.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, T as DEFAULT_USER_FILENAME, _ as DEFAULT_AGENT_WORKSPACE_DIR, b as DEFAULT_IDENTITY_FILENAME, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, m as resolveSessionAgentId, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-DuFk7JfV.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-BLprDJYq.js";
import { v as resolveUserPath } from "./utils-cwpAMi-t.js";
import { i as openBoundaryFile, u as resolvePathViaExistingAncestorSync } from "./openclaw-root-BFfBQ6FD.js";
import { t as CHANNEL_IDS } from "./registry-ds-_TqV5.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, g as sanitizeEnvVars, o as syncSkillsToWorkspace } from "./skills-B9NkSU2u.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-BLnvB3eQ.js";
import { $ as resolveAgentMainSessionKey, Q as canonicalizeMainSessionAlias, z as acquireSessionWriteLock } from "./sessions-DNn6Jbbx.js";
import { r as writeJsonAtomic } from "./json-files-DrZ4qfxw.js";
import { r as isLoopbackHost } from "./net-Bf8Z-b6p.js";
import { a as resolveCoreToolProfilePolicy, t as CORE_TOOL_GROUPS } from "./tool-catalog-CDe8aNjS.js";
import { I as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, N as DEFAULT_BROWSER_EVALUATE_ENABLED, P as DEFAULT_OPENCLAW_BROWSER_COLOR } from "./chrome-Dt8bkIrk.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, o as deriveDefaultBrowserCdpPortRange, r as registerBrowserRoutes, s as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-CBtC0TLR.js";
import { n as installBrowserCommonMiddleware, t as installBrowserAuthMiddleware } from "./server-middleware-BwkaybNn.js";
