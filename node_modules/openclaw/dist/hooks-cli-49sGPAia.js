...
import { F as loadConfig, V as writeConfigFile } from "./auth-profiles-CNyDTsy4.js";
...
import { t as CONFIG_DIR, v as resolveUserPath, x as shortenHomePath } from "./utils-cwpAMi-t.js";
...
import { a as isPathInsideWithRealpath, i as isPathInside, n as MANIFEST_KEY } from "./legacy-names-DswREgBV.js";
...
import { S as validateRegistryNpmSpec } from "./skills-B9NkSU2u.js";
...
import { l as promptYesNo } from "./tailscale-CcmGuDnz.js";
...
import { a as unscopedPackageName, c as fileExists, l as readJsonFile, n as resolveSafeInstallDir, u as resolveArchiveKind } from "./install-safe-path-lcnKyUKr.js";
import { a as installPackageDir, c as resolveTimedInstallModeOptions, f as resolveArchiveSourcePath, i as resolveCanonicalInstallTarget, l as resolveExistingInstallPath, n as installFromNpmSpecArchiveWithInstaller, o as installPackageDirWithManifestDeps, r as ensureInstallTargetAvailable, s as resolveInstallModeOptions, t as finalizeNpmSpecArchiveInstall, u as withExtractedArchiveRoot } from "./npm-pack-install-Dv0ugzgi.js";
import { t as renderTable } from "./table-Dla2Ac_E.js";
import { a as parseFrontmatter, t as loadWorkspaceHookEntries } from "./workspace-Dn54fYWU.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-BN-44AmR.js";
import { i as buildPluginStatusReport, n as resolvePinnedNpmInstallRecordForCli, r as looksLikeLocalInstallSpec, t as buildNpmInstallRecordFields } from "./npm-resolution-DlOUad2T.js";
...
async function installFromResolvedHookDir(resolvedDir, params) {
	if (await fileExists(path.join(resolvedDir, "package.json"))) return await installHookPackageFromDir({
