import { D as runExec, H as resolveAgentModelFallbackValues, U as resolveAgentModelPrimaryValue } from "./agent-scope-C6B8oVI5.js";
import { p as shouldLogVerbose, t as createSubsystemLogger, u as logVerbose, w as resolvePreferredOpenClawTmpDir } from "./subsystem-D46iuydz.js";
import { A as requireApiKey, J as loadConfig, Rn as resolveOpenClawAgentDir, at as mergeInboundPathRoots, c as normalizeProviderId, h as normalizeGoogleModelId, it as isInboundPathAllowed, j as resolveApiKeyForProvider, ot as resolveIMessageAttachmentRoots, rt as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./model-selection-Zb7eBzSY.js";
import { t as normalizeChatType } from "./chat-type-CYPyHAj-.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-B2AqzJal.js";
import { T as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-DJDSkrdD.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-D3FeIe-t.js";
import { n as fetchWithTimeout } from "./fetch-timeout-BVa_Fx_T.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-h6NrZCtQ.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-CwgIHp3a.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-Q2Qi-bwj.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-D_XBKsjt.js").then((n) => n.r);
