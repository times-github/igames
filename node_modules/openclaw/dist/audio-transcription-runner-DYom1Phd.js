import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-DWsn5rte.js";
import { p as shouldLogVerbose, t as createSubsystemLogger, u as logVerbose, w as resolvePreferredOpenClawTmpDir } from "./subsystem-nlluZawe.js";
import { _ as runExec } from "./workspace-BU8QxCQK.js";
import { Ln as resolveOpenClawAgentDir, M as resolveApiKeyForProvider, Y as loadConfig, at as isInboundPathAllowed, c as normalizeProviderId, g as normalizeGoogleModelId, it as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, j as requireApiKey, ot as mergeInboundPathRoots, st as resolveIMessageAttachmentRoots } from "./model-selection-ikt2OC4j.js";
import { t as normalizeChatType } from "./chat-type-DKb2TlGZ.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-0nwMDFtL.js";
import { T as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-5e0tgQ1Z.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-DJLxHaLt.js";
...
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-DrI0Gh6p.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DvKumK6n.js").then((n) => n.r);
