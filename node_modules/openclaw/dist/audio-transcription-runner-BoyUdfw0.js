import { a as logVerbose, c as shouldLogVerbose, k as resolvePreferredOpenClawTmpDir } from "./globals-DyWRcjQY.js";
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue } from "./agent-scope-lcHHTjPm.js";
import { n as runExec } from "./exec-C1jYNNci.js";
import { A as normalizeGoogleModelId, cn as isInboundPathAllowed, d as normalizeProviderId, ln as mergeInboundPathRoots, nt as requireApiKey, rt as resolveApiKeyForProvider, sn as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, un as resolveIMessageAttachmentRoots } from "./model-selection-CjMYMtR0.js";
import { t as normalizeChatType } from "./chat-type-CDoXBFe7.js";
import { t as describeImageWithModel } from "./image-2Bk1vmbn.js";
import { i as formatUncaughtError, n as extractErrorCode, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-BmWNPXkt.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-Bq4eA8UY.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DBRRPNBi.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DffejaoP.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-5wHpygo9.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CaKaWHKu.js";
import { n as loadModelCatalog, r as modelSupportsVision, t as findModelInCatalog } from "./model-catalog-C3SO4Y0b.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-IfymuHXF.js";
...
//#endregion
export { CLI_OUTPUT_MAX_BUFFER as _, resolveAutoImageModel as a, buildRandomTempFilePath as c, isAudioAttachment as d, resolveAttachmentKind as f, resolveMediaUnderstandingScope as g, normalizeMediaUnderstandingChatType as h, normalizeMediaAttachments as i, installUnhandledRejectionHandler as l, resolveTimeoutMs as m, buildProviderRegistry as n, resolveMediaAttachmentLocalRoots as o, resolveConcurrency as p, createMediaAttachmentCache as r, runCapability as s, runAudioTranscription as t, registerUnhandledRejectionHandler as u, applyTemplate as v };