import { A as openBoundaryFile, D as runExec, F as resolvePathViaExistingAncestorSync, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-C6B8oVI5.js";
import { a as resolveGatewayPort, n as STATE_DIR } from "./paths-CaA28K0s.js";
import { i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-D46iuydz.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-a6av96Fj.js";
import { S as truncateUtf16Safe, h as resolveUserPath } from "./utils-CNn3YdHZ.js";
import { H as resolveSecretRefValues, J as loadConfig, Q as writeConfigFile, dt as getBlockedNetworkModeReason, q as createConfigIO, ut as secretRefKey } from "./model-selection-Zb7eBzSY.js";
import { l as resolveSecretInputRef, n as parseBooleanValue, r as formatCliCommand } from "./env-D5EE512c.js";
import { t as CHANNEL_IDS } from "./registry-D1yqdHZn.js";
import { t as generateSecureToken } from "./secure-random-CFRVlPvh.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-B2AqzJal.js";
import { C as ensureChromeExtensionRelayServer, D as PROFILE_POST_RESTART_WS_TIMEOUT_MS, E as PROFILE_ATTACH_RETRY_TIMEOUT_MS, G as DEFAULT_BROWSER_EVALUATE_ENABLED, H as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, I as resolveWritablePathWithinRoot, J as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, K as DEFAULT_OPENCLAW_BROWSER_COLOR, M as DEFAULT_TRACE_DIR, N as DEFAULT_UPLOAD_DIR, O as resolveCdpReachabilityTimeouts, P as resolveExistingPathsWithinRoot, R as normalizeBrowserFormField, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_AI_SNAPSHOT_MAX_CHARS, V as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, W as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_DOWNLOAD_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, q as DEFAULT_OPENCLAW_BROWSER_ENABLED, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson, z as isLoopbackHost } from "./chrome-CdadObm0.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-vKUYIsP-.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-DQpQ0x1n.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-BpHSz0MX.js";
import { n as SsrFBlockedError } from "./proxy-env-BTrO34DI.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-WMptVzO3.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-X5yVByYG.js";
import { r as writeJsonAtomic } from "./json-files-DwMy3FOT.js";
import { H as resolveAgentMainSessionKey, V as canonicalizeMainSessionAlias, q as acquireSessionWriteLock } from "./sessions-Oj8tiZLJ.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-wfczWzTL.js";
import { o as normalizeThinkLevel } from "./thinking-kXAj2UX9.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-C5jAWrE1.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-C5jAWrE1.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
//#endregion
export { mergeAlsoAllowPolicy as $, isTransientHttpError as A, registerBrowserRoutes as B, isCompactionFailureError as C, isLikelyContextOverflowError as D, isFailoverErrorMessage as E, isTimeoutErrorMessage as F, resolveBrowserControlAuth as G, resolveProfile as H, ensureSandboxWorkspaceForSession as I, resolveSandboxConfigForAgent as J, resolveGatewayCredentialsFromConfig as K, resolveSandboxContext as L, parseImageSizeError as M, sanitizeUserFacingText as N, isRateLimitAssistantError as O, isAuthPermanentErrorMessage as P, expandPolicyWithPluginGroups as Q, resolveSandboxRuntimeStatus as R, isCloudCodeAssistFormatError as S, isFailoverAssistantError as T, getBridgeAuthForPort as U, resolveBrowserConfig as V, ensureBrowserControlAuth as W, buildPluginToolGroups as X, applyOwnerOnlyToolPolicy as Y, collectExplicitAllowlist as Z, formatBillingErrorMessage as _, isMessagingToolDuplicateNormalized as a, matchesAnyGlobPattern as at, isAuthAssistantError as b, extractToolCallsFromAssistant as c, resolveBootstrapMaxChars as ct, downgradeOpenAIFunctionCallReasoningPairs as d, stripPluginOnlyAllowlist as et, downgradeOpenAIReasoningBlocks as f, formatAssistantErrorText as g, classifyFailoverReason as h, isMessagingToolDuplicate as i, compileGlobPatterns as it, parseImageDimensionError as j, isRawApiErrorPayload as k, extractToolResultId as l, resolveBootstrapTotalMaxChars as lt, BILLING_ERROR_USER_MESSAGE as m, validateGeminiTurns as n, normalizeToolName as nt, normalizeTextForComparison as o, buildBootstrapContextFiles as ot, isGoogleModelApi as p, trimToUndefined as q, pickFallbackThinkingLevel as r, resolveToolProfilePolicy as rt, sanitizeSessionMessagesImages as s, ensureSessionHeader as st, validateAnthropicTurns as t, expandToolGroups as tt, sanitizeToolCallIdsForCloudCodeAssist as u, sanitizeGoogleTurnOrdering as ut, formatRawAssistantErrorForUi as v, isContextOverflowError as w, isBillingAssistantError as x, getApiErrorPayloadFingerprint as y, createBrowserRouteContext as z };