...
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-lcHHTjPm.js";
import { f as restoreTerminalState } from "./subsystem-BfkFJ4uQ.js";
...
import { r as resolveCliName, t as formatCliCommand } from "./command-format-Gp1OUMPH.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-BallfiRO.js";
...
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-CnQ4h1UP.js";
...
import { t as resolveOnboardingSecretInputString } from "./onboarding.secret-input-DEiy-G0p.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-w1WWEStU.js").then((n) => n.r);
