import { g as getResolvedLoggerSettings } from "./globals-d3aR1MYC.js";
import { d as resolveIsNixMode, g as resolveStateDir, m as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort, y as resolveRequiredHomeDir } from "./paths-BMo6kTge.js";
import { d as defaultRuntime } from "./subsystem-kl-vrkYi.js";
import { r as isTruthyEnvValue$1 } from "./entry.js";
import { Hn as repairOAuthProfileIdMismatch, Ii as CLAUDE_CLI_PROFILE_ID, L as readConfigFileSnapshot, Li as CODEX_CLI_PROFILE_ID, Mi as DEFAULT_MODEL, Ni as DEFAULT_PROVIDER, Sr as resolveConfiguredModelRef, V as writeConfigFile, Xn as ensureAuthProfileStore, er as updateAuthProfileStoreWithLock, fr as getModelRefStatus, l as resolveApiKeyForProfile, s as resolveProfileUnusableUntilForDisplay, ui as resolveApiKeyForProvider, wr as resolveHooksGmailModel } from "./auth-profiles-CNyDTsy4.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-DuFk7JfV.js";
import { T as parseAgentSessionKey } from "./session-key-BLprDJYq.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-cwpAMi-t.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BFfBQ6FD.js";
...
import { B as cleanStaleLockFiles, at as formatSessionArchiveTimestamp, o as loadSessionStore, ot as isPrimarySessionTranscriptFileName, tt as resolveMainSessionKey } from "./sessions-DNn6Jbbx.js";
import { n as listChannelPlugins } from "./plugins-Co0ormRA.js";
import { _ as loadOpenClawPlugins, nn as buildAuthHealthSummary, or as resolveAgentSessionDirs, rn as formatRemainingShort, tn as DEFAULT_OAUTH_WARN_MS } from "./subagent-registry-CkqrXKq4.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-Bn3zjTqJ.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DaJKh-6e.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-Bf8Z-b6p.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-BTk3jOUP.js";
import { a as resolveGatewayAuth } from "./auth-C24xIErm.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-DuT3O3nk.js";
import { n as loadModelCatalog } from "./model-catalog-qZGHxvcI.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-BLYfoMmL.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-SQ828IQ3.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-BDRu1-pk.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-CexGDVuD.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CrypJNE0.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-Dlo3GrKB.js";
import { n as DEFAULT_LOCAL_MODEL, r as resolveMemorySearchConfig } from "./manager-BpC_d51I.js";
import { t as note$1 } from "./note-BxgfXB5v.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-Cgo_Hgfj.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-J746ciD5.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CvqE4ysg.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-9EGLbHmq.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-loVEzCXX.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-BFxEl2Aa.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-D404CV2O.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DSl3qMS5.js";
import { r as healthCommand } from "./health-GBxhlVbm.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-CCK7ZNi7.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-WyHQFgHq.js";
import { t as runGatewayUpdate } from "./update-runner-kvzZzJsL.js";
import { n as logConfigUpdated } from "./logging-BmVZU1jn.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CEHVQZ3t.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-Dr-M0wH5.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CosoaEXs.js";
import { t as formatHealthCheckFailure } from "./health-format-CqfOHMzL.js";
import { n as doctorShellCompletion } from "./doctor-completion-B9Op6lVi.js";
