...
import { a as logVerbose, t as danger } from "./globals-d3aR1MYC.js";
...
import { F as loadConfig, Nn as resolveTelegramPreviewStreamMode, R as readConfigFileSnapshotForWrite, V as writeConfigFile } from "./auth-profiles-CNyDTsy4.js";
import { g as normalizeAccountId } from "./session-key-BLprDJYq.js";
import { t as CONFIG_DIR } from "./utils-cwpAMi-t.js";
import { l as resolveTelegramAccount } from "./plugins-Co0ormRA.js";
import { h as normalizeMimeType, m as kindFromMime, p as isGifMedia, u as getFileExtension } from "./image-ops-B1XQ8UAg.js";
import { n as redactSensitiveText } from "./redact-kP6dI-RQ.js";
import { i as formatUncaughtError, n as extractErrorCode, r as formatErrorMessage, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-DrflaMHL.js";
import { t as hasProxyEnvConfigured } from "./proxy-env-BxxPVbHn.js";
import { t as makeProxyFetch } from "./proxy-fetch-D397Vi7A.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-B19v3Lps.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-xeiny023.js";
import { t as renderMarkdownWithMarkers } from "./render-Bwu_WxwA.js";
import { t as resolveFetch } from "./fetch-BAIuE19S.js";
import { i as readChannelAllowFromStore } from "./pairing-store-Cf2Lg6PN.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-BJktMV0Y.js";
...
import { n as isSenderIdAllowed, r as mergeDmAllowFromSources, t as firstDefined } from "./allow-from-CrohZBvI.js";
import { n as isWSL2Sync } from "./wsl-BDRu1-pk.js";
...
//#endregion
export { buildTypingThreadParams as A, resolveTelegramReplyId as B, buildGroupLabel as C, buildTelegramGroupPeerId as D, buildTelegramGroupFrom as E, normalizeForwardedContext as F, normalizeDmAllowFromWithStore as G, resolveTelegramThreadSpec as H, resolveTelegramDirectPeerId as I, toLocationContext as J, resolveSenderAllowMatch as K, resolveTelegramForumThreadId as L, expandTextLinks as M, extractTelegramLocation as N, buildTelegramParentPeer as O, hasBotMention as P, resolveTelegramGroupAllowFromContext as R, saveCronStore as S, buildSenderName as T, isSenderAllowed as U, resolveTelegramStreamMode as V, normalizeAllowFrom as W, parseTelegramTarget as X, isVoiceCompatibleAudio as Y, resolveTelegramTargetChatType as Z, resolveTelegramFetch as _, reactMessageTelegram as a, loadCronStore as b, sendStickerTelegram as c, wasSentByBot as d, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, describeReplyTarget as j, buildTelegramThreadParams as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, sendMessageTelegram as o, markdownToTelegramChunks as p, formatLocationText as q, deleteMessageTelegram as r, sendPollTelegram as s, buildInlineKeyboard as t, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildSenderLabel as w, resolveCronStorePath as x, withTelegramApiErrorLogging as y, resolveTelegramMediaPlaceholder as z };