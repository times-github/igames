import { Mn as requireApiKey, Nn as resolveApiKeyForProvider, S as resolveIMessageAttachmentRoots, _n as normalizeGoogleModelId, b as isInboundPathAllowed, n as loadConfig, or as resolveOpenClawAgentDir, un as normalizeProviderId, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-GHoFNNPc.js";
import { T as resolvePreferredOpenClawTmpDir, p as shouldLogVerbose, t as createSubsystemLogger, u as logVerbose } from "./subsystem-QV9R1a2-.js";
import { D as runExec, H as resolveAgentModelFallbackValues, U as resolveAgentModelPrimaryValue } from "./agent-scope-Rx3XjZIq.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { n as fetchWithTimeout } from "./fetch-timeout-C-qHqfzG.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-lixKaBrx.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-TrC02Qcz.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DQ5uREi7.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-DCW28_Sn.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BATDpRbA.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-DAXP-M1C.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-KcL1DJIp.js").then((n) => n.r);
