...
import { m as normalizeAccountId, p as DEFAULT_ACCOUNT_ID } from "./session-key-CVIXEtLx.js";
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix, o as resolveOAuthDir } from "./paths-MKyEVmEb.js";
import { $t as resolveTelegramPreviewStreamMode, cr as withFileLock$1, i as readConfigFileSnapshotForWrite, n as loadConfig, o as writeConfigFile } from "./config-GHoFNNPc.js";
import { c as danger, t as createSubsystemLogger, u as logVerbose } from "./subsystem-QV9R1a2-.js";
import { g as safeParseJson, t as CONFIG_DIR } from "./utils--zJ6K5WT.js";
import { d as isTruthyEnvValue } from "./command-format-D1BnT4u1.js";
import { C as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-BmrNmh_7.js";
import { r as writeJsonAtomic } from "./json-files-BLPb80aT.js";
import { t as resolveFetch } from "./fetch-BEtAimXS.js";
import { t as redactSensitiveText } from "./redact-BDBsd4Wt.js";
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-mtZdgESV.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-yuLZOQoG.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-B6pCGvwD.js";
import { n as normalizePollInput } from "./polls-6AdLMCzg.js";
import { h as normalizeMimeType, m as kindFromMime, p as isGifMedia, u as getFileExtension } from "./image-ops-lixKaBrx.js";
import { u as hasProxyEnvConfigured } from "./ssrf-CNFE2mLw.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-B7tRnYSY.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-CueDW0Jl.js";
import { t as renderMarkdownWithMarkers } from "./render-CRfOWrdg.js";
import { t as makeProxyFetch } from "./proxy-fetch-DAXP-M1C.js";
...
//#endregion
export { isWSLEnv as $, describeReplyTarget as A, resolveTelegramStreamMode as B, buildSenderLabel as C, buildTelegramParentPeer as D, buildTelegramGroupPeerId as E, resolveTelegramDirectPeerId as F, resolveSenderAllowMatch as G, isSenderAllowed as H, resolveTelegramForumThreadId as I, parseTelegramTarget as J, isVoiceCompatibleAudio as K, resolveTelegramGroupAllowFromContext as L, extractTelegramLocation as M, hasBotMention as N, buildTelegramThreadParams as O, normalizeForwardedContext as P, isWSL2Sync as Q, resolveTelegramMediaPlaceholder as R, buildGroupLabel as S, buildTelegramGroupFrom as T, normalizeAllowFrom as U, resolveTelegramThreadSpec as V, normalizeDmAllowFromWithStore as W, formatLocationText as X, resolveTelegramTargetChatType as Y, toLocationContext as Z, renderTelegramHtmlText as _, reactMessageTelegram as a, upsertChannelPairingRequest as at, splitTelegramCaption as b, sendStickerTelegram as c, getPairingAdapter as ct, loadCronStore as d, isSenderIdAllowed as dt, isWSLSync as et, resolveCronStorePath as f, mergeDmAllowFromSources as ft, markdownToTelegramHtml as g, markdownToTelegramChunks as h, editMessageTelegram as i, removeChannelAllowFromStoreEntry as it, expandTextLinks as j, buildTypingThreadParams as k, send_exports as l, listPairingChannels as lt, isRecoverableTelegramNetworkError as m, createForumTopicTelegram as n, readChannelAllowFromStore as nt, sendMessageTelegram as o, readJsonFileWithFallback as ot, wasSentByBot as p, resolveGroupAllowFromSources as pt, normalizeTelegramLookupTarget as q, deleteMessageTelegram as r, readChannelAllowFromStoreSync as rt, sendPollTelegram as s, writeJsonFileAtomically as st, buildInlineKeyboard as t, addChannelAllowFromStoreEntry as tt, resolveTelegramVoiceSend as u, firstDefined as ut, wrapFileReferencesInHtml as v, buildSenderName as w, withTelegramApiErrorLogging as x, resolveTelegramFetch as y, resolveTelegramReplyId as z };