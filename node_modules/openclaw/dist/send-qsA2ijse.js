...
import { a as logVerbose, t as danger } from "./globals-DyWRcjQY.js";
...
import { Qt as readConfigFileSnapshotForWrite, Yt as loadConfig, qr as resolveTelegramPreviewStreamMode, tn as writeConfigFile } from "./model-selection-CjMYMtR0.js";
import { t as isTruthyEnvValue } from "./env-o3cHIFWK.js";
import { n as redactSensitiveText } from "./redact-Cl6kEomM.js";
import { i as formatUncaughtError, n as extractErrorCode, r as formatErrorMessage, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-BmWNPXkt.js";
import { t as hasProxyEnvConfigured } from "./proxy-env-DQgMiRoV.js";
import { h as normalizeMimeType, m as kindFromMime, p as isGifMedia, u as getFileExtension } from "./image-ops-Bq4eA8UY.js";
import { l as resolveTelegramAccount } from "./plugins-DeWZwV_l.js";
import { t as makeProxyFetch } from "./proxy-fetch-IfymuHXF.js";
import { t as resolveFetch } from "./fetch-Da-HEM3C.js";
import { i as readChannelAllowFromStore } from "./pairing-store-DQtghpRv.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-h_UUi8Cu.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-kN9tRjE6.js";
import { t as renderMarkdownWithMarkers } from "./render-C9RrMnL2.js";
...
import { n as isSenderIdAllowed, r as mergeDmAllowFromSources, t as firstDefined } from "./allow-from-B_rKfhTJ.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-DT-SqRES.js";
import { n as isWSL2Sync } from "./wsl-yjQQ-PJd.js";
...
//#endregion
export { buildTypingThreadParams as A, resolveTelegramReplyId as B, buildGroupLabel as C, buildTelegramGroupPeerId as D, buildTelegramGroupFrom as E, normalizeForwardedContext as F, normalizeDmAllowFromWithStore as G, resolveTelegramThreadSpec as H, resolveTelegramDirectPeerId as I, toLocationContext as J, resolveSenderAllowMatch as K, resolveTelegramForumThreadId as L, expandTextLinks as M, extractTelegramLocation as N, buildTelegramParentPeer as O, hasBotMention as P, resolveTelegramGroupAllowFromContext as R, withTelegramApiErrorLogging as S, buildSenderName as T, isSenderAllowed as U, resolveTelegramStreamMode as V, normalizeAllowFrom as W, parseTelegramTarget as X, isVoiceCompatibleAudio as Y, resolveTelegramTargetChatType as Z, markdownToTelegramHtml as _, reactMessageTelegram as a, resolveTelegramFetch as b, sendStickerTelegram as c, loadCronStore as d, resolveCronStorePath as f, markdownToTelegramChunks as g, isRecoverableTelegramNetworkError as h, editMessageTelegram as i, describeReplyTarget as j, buildTelegramThreadParams as k, send_exports as l, wasSentByBot as m, createForumTopicTelegram as n, sendMessageTelegram as o, saveCronStore as p, formatLocationText as q, deleteMessageTelegram as r, sendPollTelegram as s, buildInlineKeyboard as t, resolveTelegramVoiceSend as u, renderTelegramHtmlText as v, buildSenderLabel as w, splitTelegramCaption as x, wrapFileReferencesInHtml as y, resolveTelegramMediaPlaceholder as z };