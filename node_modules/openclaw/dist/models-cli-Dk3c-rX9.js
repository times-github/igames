import { t as CONFIG_PATH } from "./paths-BBP4yd-2.js";
import { d as colorize, f as isRich$1, p as theme } from "./globals-DyWRcjQY.js";
import { S as shortenHomePath } from "./utils-xFiJOAuL.js";
import "./thinking-44rmAw5o.js";
import { Ht as describeFailoverError, Ut as maskApiKey, a as DEFAULT_OAUTH_WARN_MS, gt as loadProviderUsageSummary, o as buildAuthHealthSummary, p as runEmbeddedPiAgent, s as formatRemainingShort, vt as formatUsageWindowSummary, yt as resolveUsageProviderId } from "./reply-DhtejUNZ.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-lcHHTjPm.js";
...
import { Cn as parseDurationMs, Ei as resolveAuthProfileDisplayLabel, Ii as DEFAULT_MODEL, Li as DEFAULT_PROVIDER, Yt as loadConfig, at as resolveEnvApiKey, bi as resolveAuthStorePathForDisplay, c as modelKey, ci as listProfilesForProvider, d as normalizeProviderId, di as upsertAuthProfile, ei as getShellEnvAppliedKeys, f as parseModelRef, g as resolveDefaultModelForAgent, gt as resolveAuthProfileOrder, h as resolveConfiguredModelRef, i as findNormalizedProviderValue, it as resolveAwsSdkEnvVarName, mi as ensureAuthProfileStore, r as buildModelAliasIndex, ri as shouldEnableShellEnvFallback, rt as resolveApiKeyForProvider, tt as getCustomProviderApiKey, ui as setAuthProfileOrder, v as resolveModelRefFromString, xi as resolveOpenClawAgentDir, xt as resolveProfileUnusableUntilForDisplay } from "./model-selection-CjMYMtR0.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-C-XXfu7J.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-B_3w5ebP.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-Db_9vfXk.js";
...
import { r as resolveForwardCompatModel } from "./model-ZurrFOi9.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-CcRJSelN.js";
import "./session-cost-usage-JyYmHRDe.js";
import { f as openUrl } from "./onboard-helpers-BallfiRO.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-BAoBKJmP.js";
import "./help-format-DcFRog9i.js";
import { r as withProgressTotals } from "./progress-BZ6ybIkX.js";
...
import { t as inferParamBFromIdOrName } from "./model-param-b-NJsgH2EF.js";
import { n as redactSecrets } from "./format-C-890_pY.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-CO_T80SL.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-Bvq9kU58.js";
import { n as logConfigUpdated } from "./logging-uAKXu_UT.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-DXy0zlaR.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-CjMYMtR0.js").then((n) => n.ht);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-ZurrFOi9.js").then((n) => n.t);
