...
import { a as setConsoleSubsystemFilter, d as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-kl-vrkYi.js";
import "./boolean-DtWR5bt3.js";
import { i as logAcceptedEnvOption, r as isTruthyEnvValue } from "./entry.js";
import { Cn as applyMergePatch, Cr as resolveDefaultModelForAgent, Di as normalizeSecretInput, Dr as resolveSubagentConfiguredModelSelection, Et as AVATAR_MAX_BYTES, F as loadConfig, H as validateConfigObjectWithPlugins, I as parseConfigJson5, In as buildTalkConfigResponse, L as readConfigFileSnapshot, M as migrateLegacyConfig, Mi as DEFAULT_MODEL, Ni as DEFAULT_PROVIDER, Nt as looksLikeAvatarPath, Ot as isAvatarHttpUrl, P as createConfigIO, R as readConfigFileSnapshotForWrite, Rn as resolveAgentMaxConcurrent, Sr as resolveConfiguredModelRef, Tn as ensureControlUiAllowedOriginsForNonLoopbackBind, U as OpenClawSchema, V as writeConfigFile, _r as normalizeModelSelection, br as resolveAllowedModelRef, cr as buildAllowedModelSet, fr as getModelRefStatus, ji as DEFAULT_CONTEXT_TOKENS, kr as resolveThinkingDefault, kt as isAvatarImageDataUrl, lt as parseDurationMs, mr as isCliProvider, sr as isPidAlive, ut as parseByteSize, wn as applyLegacyMigrations, wr as resolveHooksGmailModel, z as resolveConfigSnapshotHash, zn as resolveSubagentMaxConcurrent } from "./auth-profiles-CNyDTsy4.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-DuFk7JfV.js";
...
import { E as isPlainObject, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-cwpAMi-t.js";
...
import { i as logWarn, t as logDebug } from "./logger-BFQv53Hf.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-t2VHjaVf.js";
import "./github-copilot-token-Byc_YVYE.js";
import "./host-env-security-lcjXF83D.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-B7TNfFMY.js";
import "./env-vars-mSSOl7Rv.js";
import { C as clearInternalHooks, E as triggerInternalHook, T as registerInternalHook, h as createEmptyPluginRegistry, t as CHANNEL_IDS, u as getActivePluginRegistry, w as createInternalHookEvent } from "./registry-ds-_TqV5.js";
import { u as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DKS5Msti.js";
...
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-B9NkSU2u.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-BLnvB3eQ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-D2L2S4AM.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-vD1W0gaU.js";
import { $ as resolveAgentMainSessionKey, A as readSessionPreviewItemsFromTranscript, B as cleanStaleLockFiles, C as normalizeSessionDeliveryFields, D as capArrayByJsonBytes, E as archiveSessionTranscripts, G as resolveSessionResetPolicy, I as stripInlineDirectiveTagsForDisplay, L as stripInlineDirectiveTagsFromMessageForDisplay, M as resolveSessionTranscriptCandidates, N as stripEnvelopeFromMessage, O as cleanupArchivedSessionTranscripts, P as stripEnvelopeFromMessages, Q as canonicalizeMainSessionAlias, R as jsonUtf8Bytes, T as archiveFileOnDisk, U as evaluateSessionFreshness, Y as mergeSessionEntry, Z as setSessionRuntimeModel, d as updateSessionStore, et as resolveExplicitAgentSessionKey, it as snapshotSessionOrigin, k as readSessionMessages, n as parseSessionThreadInfo, nt as resolveMainSessionKeyFromConfig, o as loadSessionStore, t as extractDeliveryInfo, tt as resolveMainSessionKey, x as mergeDeliveryContext, y as deliveryContextFromSession } from "./sessions-DNn6Jbbx.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin, v as normalizeWhatsAppTarget } from "./plugins-Co0ormRA.js";
import { i as resolveWhatsAppAccount } from "./accounts-zRQn433-.js";
import "./accounts-K1IaOhUI.js";
import "./logging-CcxUDNcI.js";
import "./accounts-C35KnEXA.js";
import { t as buildChannelAccountBindings } from "./bindings-vxn_WYGq.js";
import "./send-M5GSjb2m.js";
import "./send-gAZjFaIg.js";
import { $ as dispatchInboundMessage, $t as persistBrowserProxyFiles, A as resolveAgentDeliveryPlan, Ar as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, At as summarizeRestartSentinel, Bt as normalizePayloadToSystemText, C as readJsonBodyWithLimit, Dr as setCommandLaneConcurrency, Dt as formatDoctorNonInteractiveHint, Er as resetAllLanes, Et as consumeRestartSentinel, F as resolveAgentAvatar, Fr as clearAgentRunContext, Ft as normalizeCronJobPatch, Gn as DEFAULT_INPUT_TIMEOUT_MS, Gt as stripLegacyDeliveryFields, H as buildHistoryContextFromEntries, Hn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Ht as migrateLegacyCronPayload, In as requestHeartbeatNow, Ir as emitAgentEvent, It as inferLegacyName, Jn as normalizeMimeList, Jt as buildSafeExternalPrompt, Kn as extractFileContentFromSource, Lr as getAgentRunContext, Lt as normalizeOptionalAgentId, M as createOutboundSendDeps, Mn as enqueueSystemEvent, Mt as writeRestartSentinel, N as createDefaultDeps, Nn as isSystemEventContextChanged, Nt as normalizeHttpWebhookUrl, O as agentCommandFromIngress, Or as waitForActiveTasks, Ot as formatRestartSentinelMessage, P as createOutboundSendDeps$1, Pr as stripHeartbeatToken, Pt as normalizeCronJobCreate, Qn as resolveSendPolicy, Qt as applyBrowserProxyPaths, Rr as onAgentEvent, Rt as normalizeOptionalSessionKey, S as handleSlackHttpRequest, Sr as getActiveTaskCount, St as resetDirectoryCache, Tn as formatZonedTimestamp, Tr as markGatewayDraining, Un as DEFAULT_INPUT_IMAGE_MIMES, Ut as buildDeliveryFromLegacyPayload, Vn as ACP_SESSION_IDENTITY_RENDERER_VERSION, Vt as normalizeRequiredName, Wn as DEFAULT_INPUT_MAX_REDIRECTS, Wt as hasLegacyDeliveryHints, Xn as resolveAgentTimeoutMs, Xt as getHookType, Yn as resolveInputFileLimits, Yt as detectSuspiciousPatterns, Zn as normalizeSendPolicy, Zt as isExternalHookSession, _ as loadOpenClawPlugins, _n as unbindThreadBindingsBySessionKey, _r as setTtsEnabled, a as runSubagentAnnounceFlow, an as applyVerboseOverride, ar as getAcpSessionManager, b as resolveAgentOutboundIdentity, bn as loadProviderUsageSummary, br as OPENAI_TTS_MODELS, bt as resolveOutboundChannelPlugin, c as abortEmbeddedPiRun, cn as consumeGatewaySigusr1RestartAuthorization, cr as clearBootstrapSnapshot, ct as setCliSessionId, d as applyToolPolicyPipeline, dn as isGatewaySigusr1RestartExternallyAllowed, dr as isTtsProviderConfigured, dt as readLatestAssistantReply, en as resolveSessionAuthProfileOverride, et as createReplyDispatcher, f as buildDefaultToolPolicyPipelineSteps, fn as markGatewaySigusr1RestartHandled, fr as resolveTtsApiKey, ft as resolveAnnounceTargetFromKey, gn as triggerOpenClawRestart, gr as resolveTtsProviderOrder, h as resolvePluginTools, hn as setPreRestartDeferralCheck, hr as resolveTtsPrefsPath, ht as resolveOutboundSessionRoute, in as applyModelOverrideToSessionEntry, it as BARE_SESSION_RESET_PROMPT, j as resolveAgentOutboundTarget, kr as CommandLane, l as getActiveEmbeddedRunCount, ln as deferGatewayRestartUntilIdle, lr as getTtsProvider, lt as runCliAgent, m as getPluginToolMeta, mn as setGatewaySigusr1RestartPolicy, mr as resolveTtsConfig, mt as ensureOutboundSessionEntry, n as initSubagentRegistry, nr as stopSubagentsForRequester, o as clearSessionQueues, on as parseVerboseOverride, or as resolveAgentSessionDirs, ot as resolveCronStyleNow, pn as scheduleGatewaySigusr1Restart, pr as resolveTtsAutoMode, qn as extractImageContentFromSource, r as listDescendantRunsForRequester, s as runEmbeddedPiAgent, sn as buildOutboundSessionContext, sr as resolveUserTimezone, st as getCliSessionId, t as countActiveDescendantRuns, tr as isAbortRequestText, tt as getTotalPendingReplies, u as waitForEmbeddedPiRunEnd, un as emitGatewayRestart, ur as isTtsEnabled, ut as createOpenClawTools, v as createPluginRuntime, vn as normalizeGroupActivation, vr as setTtsProvider, vt as resolveOutboundTarget, w as requestBodyErrorToText, wr as getTotalQueueSize, wt as runWithModelFallback, xr as OPENAI_TTS_VOICES, yr as textToSpeech, yt as resolveSessionDeliveryTarget, zr as registerAgentRunContext, zt as normalizeOptionalText } from "./subagent-registry-CkqrXKq4.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-Bn3zjTqJ.js";
...
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-CcmGuDnz.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-C24xIErm.js";
import { l as ensureGatewayStartupAuth, u as mergeGatewayTailscaleConfig } from "./server-context-CBtC0TLR.js";
import "./paths-8MkNWbbj.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-kP6dI-RQ.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-DrflaMHL.js";
import { i as openFileWithinRoot, l as writeFileWithinRoot, s as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-kadrhuVr.js";
import { n as SsrFBlockedError } from "./proxy-env-BxxPVbHn.js";
import "./store-D0GaA-PU.js";
import { n as inspectPortUsage, o as formatPortDiagnostics, t as ensurePortAvailable } from "./ports-DuT3O3nk.js";
...
import { n as loadModelCatalog } from "./model-catalog-qZGHxvcI.js";
import "./fetch-C79EVYRM.js";
import { g as registerUnhandledRejectionHandler } from "./audio-transcription-runner-Bq3uEE74.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BUZ81J83.js";
import { x as extractTextFromChatContent } from "./image-BfgjMXod.js";
import "./tool-display-3t3R7qfs.js";
import "./api-key-rotation-Coo663aY.js";
import "./proxy-fetch-D397Vi7A.js";
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-D_u8yoXQ.js";
import "./chunk-DVb2QTEm.js";
import "./markdown-tables-B19v3Lps.js";
import "./ir-xeiny023.js";
import "./render-Bwu_WxwA.js";
import { a as ToolInputError } from "./target-errors-fYvvIqQ5.js";
import { r as isRestartEnabled } from "./commands-D38uo2qR.js";
import "./commands-registry-BO-Nhy_d.js";
import "./fetch-BAIuE19S.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-Cf2Lg6PN.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-C9gzInje.js";
import { _ as matchSystemRunApprovalBinding, g as buildSystemRunApprovalBinding, h as resolveSystemRunApprovalRuntimeContext, m as resolveSystemRunApprovalRequestContext, v as missingSystemRunApprovalBinding, y as toSystemRunApprovalMismatchError } from "./nodes-screen-DZmNM68b.js";
import { n as resolveSystemRunCommand } from "./system-run-command-CgLq7n8_.js";
...
import { n as resolveMessageChannelSelection } from "./channel-selection-U4t706rb.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-DL7j3Ezh.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-SQ828IQ3.js";
import "./proxy-CWm5cGVU.js";
import "./replies-Xw6QgU11.js";
import { f as isKnownSecretTargetId, n as GATEWAY_AUTH_SURFACE_PATHS, r as evaluateGatewayAuthSurfaceStates } from "./runtime-config-collectors-BJhmqEOW.js";
import "./command-secret-targets-B3asrqY0.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-CexGDVuD.js";
import "./prompt-style-CrypJNE0.js";
import "./pairing-labels-CYa_tb9P.js";
import "./session-meta-DnFhj0uA.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-Dlo3GrKB.js";
import { r as resolveMemorySearchConfig } from "./manager-BpC_d51I.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DCWZNKY_.js";
import { t as isWithinDir } from "./path-safety-MlUZHPy2.js";
import "./install-safe-path-lcnKyUKr.js";
import "./skill-scanner-DJCxso6d.js";
import { n as formatConfigIssueLines } from "./issue-format-L1nDZPRU.js";
import { t as buildChannelAccountSnapshot } from "./status-BuNjhGZU.js";
import "./channels-status-issues-Cgo_Hgfj.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-DZnprkgC.js";
...
import "./lifecycle-core-DV9USLmW.js";
import "./systemd-hints-BFxEl2Aa.js";
import { t as parsePort$1 } from "./parse-port-DjjWDROB.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-BzWDjz3u.js";
import "./diagnostics-D404CV2O.js";
import "./table-Dla2Ac_E.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-2xJLrUlp.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Cj1TkwFW.js";
import { a as probeGateway, n as collectEnabledInsecureOrDangerousFlags } from "./audit-Cu_xW7y4.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DfQjnLiU.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-DbyE3ZwA.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-GBxhlVbm.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CCK7ZNi7.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-WyHQFgHq.js";
import { a as resolveCommandSecretsFromActiveRuntimeSnapshot, i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-BEznv9Yj.js";
import "./onboarding.secret-input-lldLv7cT.js";
import { t as runOnboardingWizard } from "./onboarding-CV_U-ReY.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BSqVJlI-.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-C3-LwL9E.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-BH9kIzbc.js";
import "./node-service-DJgspZ6W.js";
import "./status.update-cXbzvaVi.js";
import { t as installSkill } from "./skills-install-CegMvVTR.js";
import { t as runGatewayUpdate } from "./update-runner-kvzZzJsL.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-Dn54fYWU.js";
import { n as forceFreePortAndWait } from "./ports-CA2O4PcN.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-QfvZu_0c.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-BTlxpaWR.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-C8ozL0nD.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BiQk_YG-.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-DPAduhp1.js").then((n) => n.n);
