...
import { hn as sensitive } from "./model-selection-CjMYMtR0.js";
...
const FIELD_HELP = {
	...
	"agents.defaults.memorySearch.provider": "Selects the embedding backend used to build/query memory vectors: \"openai\", \"gemini\", \"voyage\", \"mistral\", \"ollama\", or \"local\". Keep your most reliable provider here and configure fallback for resilience.",
	...
	"agents.defaults.memorySearch.fallback": "Backup provider used when primary embeddings fail: \"openai\", \"gemini\", \"voyage\", \"mistral\", \"ollama\", \"local\", or \"none\". Set a real fallback for production reliability; use \"none\" only if you prefer explicit failures.",
	...
	"channels.telegram.streaming": "Unified Telegram stream preview mode: \"off\" | \"partial\" | \"block\" | \"progress\" (default: \"partial\"). \"progress\" maps to \"partial\" on Telegram. Legacy boolean/streamMode keys are auto-mapped.",
...
function mapSensitivePaths(schema, path, hints) {
	...
	else if (isSensitiveConfigPath(path) && !next[path]?.sensitive) log$1.debug(`possibly sensitive key found: (${path})`);
