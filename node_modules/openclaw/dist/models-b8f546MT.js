...
import { r as resolveForwardCompatModel } from "./model-bzHG4u0Y.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DTh-dRmO.js";
import { Cn as resolveUsageProviderId, Sn as formatUsageWindowSummary, Tt as describeFailoverError, bn as loadProviderUsageSummary, nn as buildAuthHealthSummary, rn as formatRemainingShort, s as runEmbeddedPiAgent, tn as DEFAULT_OAUTH_WARN_MS, wn as maskApiKey } from "./subagent-registry-CkqrXKq4.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-Bn3zjTqJ.js";
import { t as ensureOpenClawModelsJson } from "./models-config-ERyMYjbg.js";
import { n as loadModelCatalog } from "./model-catalog-qZGHxvcI.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-B3asrqY0.js";
import { f as openUrl } from "./onboard-helpers-CexGDVuD.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DMFQyZNx.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-xKTlRWep.js";
import { n as logConfigUpdated } from "./logging-BmVZU1jn.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-B_C2QsBT.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-CNyDTsy4.js").then((n) => n.t);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-bzHG4u0Y.js").then((n) => n.t);
