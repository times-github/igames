...
export function extractFunctionCallSettingsFromJinjaTemplate({ idsGenerator, renderTemplate }) {
    ...
    if (revivedParallelismCallSectionPrefix.values.length === 0 && renderedOnlyCall != null) {
        ...
        if (userMessage1ToModelMessage1Start.text != null && onlyCallUserMessage1ToFunc1Name.text != null) {
            const onlyCallModelMessagePrefixLength = findCommonStartLength(userMessage1ToModelMessage1Start.text, onlyCallUserMessage1ToFunc1Name.text);
    ...
    const { whitespacePrefix: revivedCallWhitespacePrefix, newTarget: cleanRevivedCallPrefix } = extractWhitespacePrefixFromRevivedText(revivedCallPrefix);
    const { whitespacePrefix: revivedParallelismWhitespacePrefix, newTarget: cleanRevivedParallelismCallSectionPrefix } = extractWhitespacePrefixFromRevivedText(LlamaText([
...
function extractWhitespacePrefixFromRevivedText(target) {
...
function findCommonStartLength(text1, text2) {
