...
export class LlamaChatSession {
     ...
     * @param [options]
     */
    async promptWithMeta(prompt, { functions, documentFunctionParams, maxParallelFunctionCalls, onTextChunk, onToken, onResponseChunk, onFunctionCallParamsChunk, budgets, signal, stopOnAbortSignal = false, maxTokens, temperature, minP, topK, topP, seed, xtc, grammar, trimWhitespaceSuffix = false, responsePrefix, repeatPenalty, dryRepeatPenalty, tokenBias, customStopTriggers, evaluationPriority } = {}) {
     ...
     * @param [options]
     */
    async completePromptWithMeta(prompt, { maxTokens, stopOnAbortSignal = false, functions, documentFunctionParams, onTextChunk, onToken, signal, temperature, minP, topK, topP, seed, xtc, grammar, trimWhitespaceSuffix = false, repeatPenalty, dryRepeatPenalty, tokenBias, customStopTriggers, evaluationPriority, completeAsModel } = {}) {
        this._ensureNotDisposed();
        if (grammar != null) {
